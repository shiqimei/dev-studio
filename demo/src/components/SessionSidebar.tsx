    ...
    <div className="sidebar-container">
      ...
      <div
        ...
        onScroll={(e) => {
          ...
          (el as any)._scrollTimer = setTimeout(() => el.classList.remove("is-scrolling"), 800);
        }}
      >
  ...
  return (
    <div ref={footerRef} className="relative shrink-0">
      ...
      <div className="px-4 py-3 border-t border-border flex items-center gap-2">
        ...
        <span className="text-[11px] font-semibold text-text opacity-50">Claude Code ACP</span>
