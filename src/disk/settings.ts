...
import { ACP_TOOL_NAME_PREFIX, acpToolNames } from "../acp/types.js";
import {
  getManagedSettingsPath,
  getUserSettingsPath as getUserSettingsPathFn,
  getProjectSettingsPath as getProjectSettingsPathFn,
  getLocalSettingsPath as getLocalSettingsPathFn,
} from "./paths.js";
...
export class SettingsManager {
  ...
  private getProjectSettingsPath(): string {
    return getProjectSettingsPathFn(this.cwd);
  }
  ...
  private getLocalSettingsPath(): string {
    return getLocalSettingsPathFn(this.cwd);
  }
